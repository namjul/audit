  ...
  return {
    ...
    async generateBundle(opts, bundle) {
      ...
      for (const n in bundle) {
        ...
        const baseDtsFilename = path__namespace["default"].basename(dtsFileName); // TODO: technically this is wrong because you could have a default type-only export
...
async function writeDevTSFiles(entrypoint, hasDefaultExport) {
  ...
  let promises = [fs__namespace.outputFile(dtsReexportFilename, dtsTemplate(baseDtsFilename, hasDefaultExport, relativePathWithExtension.replace(/\.tsx?$/, ""), relativePathWithExtension))];
